...
enum msgtable_messages {
	...
	MSGTBL_EXVEND_NOT_ENOUGH_CASH = 1590,
	MSGTBL_EXVEND_NOT_ENOUGH_ITEMS = 1591,
	MSGTBL_EXVEND_SELLER_NO_SPACE = 1592,
	MSGTBL_EXVEND_SELLER_CANT_TAKE = 1593,
	MSGTBL_EXVEND_SELECTED = 1594,
	MSGTBL_EXVEND_OPENED_SHOP = 1595,
	MSGTBL_EXVEND_CURRENT_CURRENCY = 1596,
	MSGTBL_EXVEND_BOUGHT_ITEM = 1597,
	MSGTBL_EXVEND_FULL_REVENUE = 1598,
	MSGTBL_EXVEND_STORE_BOUGHT = 1599,
	MSGTBL_EXVEND_ITEM_AMOUNT = 1600,
	MSGTBL_EXVEND_AND_MORE = 1601,
	MSGTBL_EXVEND_PROFIT_ZENY = 1602,
	MSGTBL_EXVEND_PROFIT_ITEM = 1603,
	MSGTBL_EXVEND_BOUND_ITEMS = 1604,
	MSGTBL_EXVEND_SELLER_NO_SPACE2 = 1605,
	MSGTBL_EXVEND_SERVER = 1606,
	MSGTBL_EXVEND_REPORT = 1607,
